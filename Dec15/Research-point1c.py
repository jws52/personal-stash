...
def load_and_analyse():
    ...
    calc_type = input(["To calculate differences from baseline, type 1 (option to calculate absolute values will be given later) "])     
    while calc_type not in [1]: calc_type = input(["Not recognised, try again. type 1"])  
